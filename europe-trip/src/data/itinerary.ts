...
const LOCATIONS: Record<string, string> = {
  ...
  '✈️ llegada 9:45 am': 'https://www.google.com/maps/search/?api=1&query=Madrid+Barajas+Airport',
  '✈️ vuelo madrid → florencia': 'https://www.google.com/maps/search/?api=1&query=Madrid+Barajas+Airport',
  'firenze santa maria novella': 'https://www.google.com/maps/search/?api=1&query=Firenze+Santa+Maria+Novella',
  '🚆 tren florencia → milán 11:16 am': 'https://www.google.com/maps/search/?api=1&query=Firenze+Santa+Maria+Novella',
  ...
  '✈️ vuelo zúrich → bruselas 10:20 am': 'https://www.google.com/maps/search/?api=1&query=Zurich+Airport',
  'estación central de bruselas': 'https://www.google.com/maps/search/?api=1&query=Brussels+Central+Station',
  '🚆 tren bruselas → parís 12:58 pm': 'https://www.google.com/maps/search/?api=1&query=Brussels+Central+Station',
  'aeropuerto de parís-orly': 'https://www.google.com/maps/search/?api=1&query=Paris+Orly+Airport',
  '✈️ vuelo parís → madrid 1:36 pm': 'https://www.google.com/maps/search/?api=1&query=Paris+Orly+Airport',
